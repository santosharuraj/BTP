...
const FindFireIndex = () => {
	...
	const onChangeValue = (e, id) => {
		console.log("e.target.value.trim().length", e.target.value.length);
	...
	return (
		<>
			...
			<div className="FindFEI">
				<span>Find Fire & Explosion Index</span>

				<FormControl sx={{ m: 1, width: 300 }} style={{ width: "455px" }}>
					<InputLabel id="demo-multiple-name-label">Select Material</InputLabel>
					<Select
				...
				<div className="each_item">
					<Card className="heading">
						<div>
							<span>Select General Process Hazards</span>
						</div>
						<div>
								...
								<div>
									...
									<div>
										<TextField
											...
											type="number"
											disabled={
												checked.filter((obj) => obj.id == item.id).length > 0
													? false
													: true
											}
				...
				<div className="each_item">
					<Card className="heading">
						<div>
							<span>Select Special Process Hazards</span>
						</div>
						<div>
							<span style={{ color: "blue" }}>Penalty Factor Range</span>
						</div>
								...
								<div>
									...
									<div>
										<TextField
											...
											disabled={
												checkedSpec.filter((obj) => obj.id == item.id).length >
												0
													? false
													: true
											}
